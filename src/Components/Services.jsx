...
const Services = () => {
  ...
  return (
    <div className='py-10 bg-base-200'>
      ...
      <p className='text-center text-[14px] md:text-lg max-w-[80%] md:max-w-auto mx-auto'>Beautifully crafted decoration packages for unforgettable celebrations - book a pro decorator today.</p>
